    ...
    def __init__(self):
        ...
        for i, j in zip(range(10, 1811, 360), range(5)):
            ...
            if sum(self.board[j]) > 9:
                ...
                x = 240
            draw.text(
                (1810 + x, i + 20), str(sum(self.board[j])), (0, 0, 0), font=self.font
            )
            draw.text(
                (2050, i + 180), str(self.board[j].count(0)), (0, 0, 0), font=self.font
            )
            ...
            for j in range(5):
                if not self.flip[i][j]:
                    if self.board[i][j] == 0:
                        self.bg.paste(
                            self.voltorb_tile,
                            ((j + 1) * 360 - 350, (i + 1) * 360 - 350),
                        )
                    elif self.board[i][j] == 1:
                        self.bg.paste(
                            self.tile_1, ((j + 1) * 360 - 350, (i + 1) * 360 - 350)
                        )
                    elif self.board[i][j] == 2:
                        self.bg.paste(
                            self.tile_2, ((j + 1) * 360 - 350, (i + 1) * 360 - 350)
                        )
                    elif self.board[i][j] == 3:
                        self.bg.paste(
                            self.tile_3, ((j + 1) * 360 - 350, (i + 1) * 360 - 350)
                        )
                    self.flip[i][j] = True
    ...
    def edit(self, name, temp):
        ...
        if not self.flip[pos[0] - 1][pos[1] - 1]:
            if self.board[pos[0] - 1][pos[1] - 1] == 0:
                self.bg.paste(
                    self.hl_voltorb_tile, (pos[1] * 360 - 350, pos[0] * 360 - 350)
                )
    ...
    def edit_all(self, name, rowcol, num):
            ...
            for i in range(5):
                if not self.flip[num - 1][i]:
                    if self.board[num - 1][i] == 0:
                        self.bg.paste(
                            self.hl_voltorb_tile, ((i + 1) * 360 - 350, num * 360 - 350)
                        )
                        ...
                        self.bg.paste(
                            self.tile_1, ((i + 1) * 360 - 350, num * 360 - 350)
                        )
                    elif self.board[num - 1][i] == 2:
                        self.bg.paste(
                            self.tile_2, ((i + 1) * 360 - 350, num * 360 - 350)
                        )
                        coins *= 2
                    elif self.board[num - 1][i] == 3:
                        self.bg.paste(
                            self.tile_3, ((i + 1) * 360 - 350, num * 360 - 350)
                        )
                        coins *= 3
                    self.flip[num - 1][i] = True
        ...
        for i in range(5):
            if self.board[i][num - 1] == 0:
                self.bg.paste(
                    self.hl_voltorb_tile, (num * 360 - 350, (i + 1) * 360 - 350)
                )
